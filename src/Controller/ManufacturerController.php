...
class ManufacturerController extends AbstractController
{
    ...
    {
        return $this->render('manufacturer/index.html.twig', ['manufacturers' => $manufacturerRepository->findAll()]);
    }
    ...
    {
        return $this->render('manufacturer/show.html.twig', ['manufacturer' => $manufacturer]);
    }
    ...
    public function edit(Request $request, Manufacturer $manufacturer): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('manufacturer_index', ['id' => $manufacturer->getId()]);
        }
